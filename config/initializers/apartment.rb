...
Apartment.configure do |config|
  ...
  #
  config.excluded_models = %w{Customer UserLink}
...
Rails.application.config.middleware.insert_before Warden::Manager, CustomElevator
CustomElevator.excluded_subdomains = CtmsRouting::excluded_subdomains
